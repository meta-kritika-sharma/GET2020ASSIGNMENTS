...
case 13:
        ...
        String side1_1id=  request.getParameter("side116");
            java.lang.String side1_1idTemp = null;
        if(!side1_1id.equals("")){
         side1_1idTemp  = side1_1id;
        }
        String side2_2id=  request.getParameter("side218");
            java.lang.String side2_2idTemp = null;
        if(!side2_2id.equals("")){
         side2_2idTemp  = side2_2id;
        }
        String side3_3id=  request.getParameter("side320");
            java.lang.String side3_3idTemp = null;
        if(!side3_3id.equals("")){
         side3_3idTemp  = side3_3id;
        }
        java.lang.String area13mtemp = sampleTriangleProxyid.area(side1_1idTemp,side2_2idTemp,side3_3idTemp);
if(area13mtemp == null){
%>
<%=area13mtemp %>
<%
